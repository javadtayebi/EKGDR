...
def read_triplets(file_name):
    ...
    # print(can_triplets_np)
    can_triplets_np = np.unique(can_triplets_np, axis=0)

    # print(args.inverse_r)
    if args.inverse_r:
...
def load_data(model_args):
    ...
    if args.splitting_mode == 'per-user':
      ...
      print('reading whole user-item_interactions set ...')
      whole_cf = read_cf(directory + 'user_item_interactions.txt')
      # print(whole_cf)

      print('train/test splitting, over whole user-item interactions ...')
      train_cf, test_cf = train_test_split(
          whole_cf,
          test_size=0.2,
          shuffle=True
      )
